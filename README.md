...
This is an unofficial library provided by an individual, the author is not
affiliated with HaloPSA

## Prerequisites

You need to provide a client_id and client_secret from an application you
created inside your own HaloPSA instance, details on how to set this up can be
found in the official HaloPSA documentation and is out of scope for this
repository.
